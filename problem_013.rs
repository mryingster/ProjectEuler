// -*- compile-command: "rustc -o problem_013_rs problem_013.rs" -*-
// Copyright (c) 2016 Michael Caldwell

fn main() {

    let mut numbers: [[u16; 50]; 100] = [
    ...
    for n in 1..numbers.len() {
        for d in 0..numbers[n].len() {
            numbers[n][d] += numbers[n-1][d];
        }
    }

    let mut answer:u64 = numbers[99][0] as u64;

    for i in 1..13 {
        answer *= 10;
        answer += numbers[99][i] as u64;
    }
